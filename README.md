...
> **Note**: No `if-else` or `switch` statements will be used.
...
public class AccountTest() {
    public static void main(String[] args) {
        ...
        // Deposit to the account
        myAccount.deposit(1000.0); // Updates balance and displays account number and current balance. Calls the toString() method in deposit().
        
        // Withdraw from the account
        myAccount.withdraw(100.0); // Updates balance and displays account number and current balance. Calls the toString() method in withdraw().
        ...
        // Withdraw from the account
        myAccount.withdraw(500.0); // Displays "You cannot withdraw on a closed account!". Calls the toString() method to show current balance and account number.
        
        // Deposit to the account
        myAccount.deposit(1000.0); // Displays "You cannot deposit on a closed account!". Calls the toString() method to show current balance and account number.
    }
>>>>>>> 203a040 (Moved root directory of repo)
}
